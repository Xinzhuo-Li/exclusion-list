...
| GENERAL | TYPE OF ENTITY/PROFESSION | Truncate to 20 |
| NPI | NPI | 10-digit validation |
| ADDRESS | ADDRESS | Truncate to 30 |
...
| GENERAL | Provider Type | Truncate to 20 |
| NPI | National Provider Identifier (NPI) | 10-digit validation |
| STATE | — | Default MA |
| EXCLTYPE | Suspension/Exclusion Reason | Truncate to 9 |
...
| GENERAL | Provider Category | Truncate to 20 |
| NPI | NPI# | 10-digit validation |
| CITY | City | Direct |
| STATE | — | Default MI |
...
| GENERAL | Provider Type | Truncate to 20 |
| SPECIALTY | Provider Speciality | Truncate to 20 |
| NPI | NPI | 10-digit validation |
| DOB | Date of Birth | Excel serial → YYYYMMDD |
| ADDRESS | Address Line 1 + 2 | Combined, truncate to 30 |
| CITY | City | Direct |
...
| GENERAL | Healthcare Profession | Truncate to 20 |
| NPI | NPI | 10-digit validation |
| STATE | — | Default MT |
...
| GENERAL | Provider Type Code | Truncate to 20 |
...
- Dropped exact duplicates are logged to `docs/dedup_dropped_{state}.json`
